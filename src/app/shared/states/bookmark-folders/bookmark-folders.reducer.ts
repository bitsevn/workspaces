...
import { BookmarkFoldersActions, BookmarkFoldersActionTypes } from './bookmark-folders.actions';
import { IBookmarkFoldersState, IBookmarkFolder } from './bookmark-folders.interface';

export const bookmarkFoldersEntityAdapter: EntityAdapter<IBookmarkFolder> = createEntityAdapter<
  IBookmarkFolder
>();
...
const initialState: IBookmarkFoldersState = bookmarkFoldersEntityAdapter.getInitialState({
  ...
  entities: {
    ...
    12: {
      ...
      bookmarks: [{ id: 115, name: 'Financials' }, { id: 116, name: 'Returns Vs. Index Returns' }]
    }
  }
});
